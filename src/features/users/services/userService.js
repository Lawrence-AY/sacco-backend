...
const updateUser = async (id, data) => {
  try {
    ...
    await user.update({
      ...
      payrollNumber: data.payrollNumber ?? user.payrollNumber,
      nextOfKinName: data.nextOfKinName ?? user.nextOfKinName,
      nextOfKinRelationship: data.nextOfKinRelationship ?? user.nextOfKinRelationship,
      nextOfKinPhone: data.nextOfKinPhone ?? user.nextOfKinPhone,
