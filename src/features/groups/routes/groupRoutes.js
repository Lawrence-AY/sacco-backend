...
router.post('/:groupId/governance/actions', controller.proposeGovernanceAction);
router.post('/:groupId/governance/actions/:actionId/vote', controller.voteGovernanceAction);
